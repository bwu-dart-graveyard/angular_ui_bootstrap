...
[![Build Status](https://drone.io/github.com/bwu-dart/angular_ui_bootstrap/status.png)](https://drone.io/github.com/bwu-dart/angular_ui_bootstrap/latest)
<!--
...
We are aiming at providing a set of AngularDart directives based on Twitter Bootstrap's markup and CSS. The goal is to provide **native AngularDart directives** without any dependency on jQuery or Bootstrap's JavaScript.
It is often better to rewrite an existing JavaScript code and create a new, pure AngularDart directive. Most of the time the resulting directive is smaller as compared to the orginal JavaScript code size and better integrated into the AngularDart ecosystem.
